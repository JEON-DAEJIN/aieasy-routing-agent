...
CATEGORY_DESCRIPTIONS = {
    "CONCEPT": "AI가 무엇인지, 어떻게 학습하는지, 환각·데이터 품질처럼 AI의 개념/한계에 대한 질문",
    "PROMPT": "프롬프트가 무엇인지, 어떻게 잘 쓰는지(역할·과업·형식·제약)에 대한 질문",
    "APPLY": "AI를 일상 문제에 어떻게 활용하는지, 앞으로 무엇을 더 배우면 좋을지에 대한 질문",
